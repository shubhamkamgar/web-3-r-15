...
const Index = () => {
  ...
  const trustIndicators = [
    ...
    { icon: Award, text: "Industry Recognition", color: "text-yellow-500" },
    { icon: Clock, text: "24/7 Support", color: "text-blue-500" },
    { icon: Globe, text: "Global Reach", color: "text-purple-500" }
  ];

  // Enhanced floating elements
  const floatingElements = [
    { icon: Sparkles, delay: 0, x: "10%", y: "20%" },
    { icon: Rocket, delay: 2, x: "80%", y: "15%" },
    { icon: BarChart3, delay: 4, x: "15%", y: "70%" },
    { icon: Target, delay: 6, x: "85%", y: "75%" }
  ];
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto py-8 sm:py-12 md:py-16 lg:py-20 relative z-10">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            ...
            >
              ...
              <motion.h1 
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight sm:leading-tight md:leading-tight"
              ...
              <motion.p 
                className="text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-8 leading-relaxed px-2 sm:px-0"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, delay: 0.4 }}
              >
                Leverage cutting-edge artificial intelligence to skyrocket your marketing performance, 
                generate more leads, and increase revenue by up to 300% in just 90 days.
              </motion.p>
              ...
              <motion.div 
                className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-3 sm:px-0"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { number: "300%", label: "Average ROI Increase", icon: TrendingUp, color: "from-green-500 to-emerald-500" },
              { number: "90", label: "Days to See Results", icon: Clock, color: "from-blue-500 to-cyan-500" },
              { number: "500+", label: "Businesses Transformed", icon: Users, color: "from-purple-500 to-pink-500" }
            ].map((stat, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <motion.div 
                  className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-400 mb-1 sm:mb-2 relative z-10"
                  animate={{ 
                    textShadow: [
      ...
      <section className="bg-gradient-to-r from-gray-50 to-blue-50 py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 px-3 sm:px-4 md:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <motion.p 
              className="text-base sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-2 sm:px-0"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              ...
              className="relative rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-blue-900 via-purple-900 to-blue-900"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              {/* Animated border */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 opacity-75"
                animate={{
                  background: [
                    "linear-gradient(0deg, #3b82f6, #8b5cf6, #ec4899)",
                    "linear-gradient(120deg, #3b82f6, #8b5cf6, #ec4899)",
                    "linear-gradient(240deg, #3b82f6, #8b5cf6, #ec4899)",
                    "linear-gradient(360deg, #3b82f6, #8b5cf6, #ec4899)"
                  ]
                }}
                transition={{ duration: 4, repeat: Infinity }}
                style={{ padding: "2px", borderRadius: "16px" }}
              >
          ...
          >
            ...
            >
              <img 
                ...
                alt="AI AdMaxify team working together"
                className="w-full h-[250px] sm:h-[300px] md:h-[400px] object-cover group-hover:scale-105 transition-transform duration-700"
              />
              ...
              >
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden bg-gradient-to-br from-white to-gray-50 group-hover:from-blue-50 group-hover:to-purple-50">
                  <CardContent className="p-6 text-center relative">
                    ...
                    <div className="relative mb-4">
                      ...
                      >
                        <img
                          src={member.image}
                          alt={member.name}
                          className="w-20 h-20 sm:w-24 sm:h-24 rounded-full mx-auto object-cover transition-all duration-500 group-hover:shadow-xl"
                        />
                    ...
                    <motion.h3 
                      className="text-base sm:text-lg font-bold text-gray-900 mb-1 group-hover:text-blue-700 transition-colors relative z-10 leading-tight"
                      whileHover={{ scale: 1.05 }}
                    >
                      {member.name}
                    </motion.h3>
                    <motion.p 
                      className="text-sm sm:text-base text-blue-600 font-medium relative z-10 leading-tight"
                      animate={{
      ...
      <section className="bg-gradient-to-r from-blue-50 to-purple-50 py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              { number: "2,847%", label: "Lead Generation Increase", icon: TrendingUp },
              { number: "300%", label: "Average ROI Boost", icon: DollarSign },
              { number: "90", label: "Days to Results", icon: Clock },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  "Advanced AI algorithms that learn and adapt",
                  "Proven track record with 500+ successful campaigns",
                  "Dedicated team of AI marketing specialists",
      ...
      <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 text-white py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-blue-600/50 via-purple-600/50 to-pink-600/50"
            animate={{
              background: [
                "linear-gradient(45deg, rgba(37, 99, 235, 0.5), rgba(147, 51, 234, 0.5), rgba(219, 39, 119, 0.5))",
                "linear-gradient(135deg, rgba(37, 99, 235, 0.5), rgba(147, 51, 234, 0.5), rgba(219, 39, 119, 0.5))",
                "linear-gradient(225deg, rgba(37, 99, 235, 0.5), rgba(147, 51, 234, 0.5), rgba(219, 39, 119, 0.5))",
                "linear-gradient(315deg, rgba(37, 99, 235, 0.5), rgba(147, 51, 234, 0.5), rgba(219, 39, 119, 0.5))"
              ]
            }}
