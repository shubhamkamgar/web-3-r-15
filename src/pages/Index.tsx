         ...
         {/* =========================================== Team working photo ==============================================================*/}
          ...
          once: true
            ...
            boxShadow: "0 25px 50px rgba(0,0,0,0.15)"
              ...
              <img src="https://drive.google.com/file/d/1YRd4CW9yTi-ilwceroBu_OqBMRj4MitB/view?usp=sharing?w=1200&h=600&fit=crop" alt="AI AdMaxify team working together" className="w-full h-[250px] sm:h-[300px] md:h-[400px] object-cover group-hover:scale-105 transition-transform duration-700" />
